...
const AddModules = ({setClose}) => {
 ...
 const handleSubmit = () => {
  ...
  const [showAddContentPopUp,setAddContentPopUp] = useState(false)
  return (<div className="add_modules_main_container">
     <div className="add_modules_body_container">
        <div className="add_modules_header">
            <h2>Add Modules</h2>
        </div>
        <div className="add_modules_content">
            <div className="add_modules_title">
                <p>Title : </p>
            ...
            </div>
           {
            data?.topics?.map((topic, index) => {
                return <div className="add_modules_topic">
                    <p>Topic {index+1}: </p>
                  <div className="input_topic_modules">
     ...
     {
        showAddContentPopUp && <AddContent setData={setData} index={index} data={data}  setClose={setAddContentPopUp}/>
     }
  </div>
  )
}
